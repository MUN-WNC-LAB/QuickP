...
def sampling_based_near_optimal_schedule(model: Model, start, finish, comm_start, comm_end, comp_graph: CompGraph,
                                         device_relied_component_mapping: dict, edge_cut_list: list, operator_device_mapping: dict,
                                         rho, sampling_function):
    # The global data dependency is already applied
    M = 1000000
    order = {}
    fifo_operator_order, _ = FIFO_scheduling_order(comp_graph, device_relied_component_mapping, edge_cut_list,
