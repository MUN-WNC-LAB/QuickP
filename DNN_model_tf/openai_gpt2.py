...
def test_openai_gpt2_model():
    # tokenizer is the encoder of the text input
    model, tokenizer = get_openai_gpt2_model(), get_openai_gpt2_tokenizer()
    print(model.summary())
    '''
    {'input_ids': <tf.Tensor: shape=(1, batch_size), dtype=int32, numpy=array([[15496,    11,   616,  3290,   318, 13779]], dtype=int32)>,
    'attention_mask': <tf.Tensor: shape=(1, batch_size), dtype=int32, numpy=array([[1, 1, 1, 1, 1, 1]], dtype=int32)>}
